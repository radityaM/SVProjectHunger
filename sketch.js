...
function preload(){
    ...
    playImg=loadImage("buttonplay.png");
...
function draw(){
    ...
    if(gameState===PLAY){
        ...
        if(keyDown("SPACE")&&player.y>displayHeight-300){
            player.velocityY=-30;
        }
    ...
    if(gameState===INFORMATION){
        ...
        text("Remember: A balanced diet makes a healthy body!",displayWidth/2-700,displayHeight/2+260);
        ...
        if(mousePressedOver(infoBack)&&whereBack===0){
            gameState=START;
            foodPyramid.visible=false;
            infoBack.visible=false;
        }else if(mousePressedOver(infoBack)&&whereBack===1){
            win=0;
            gameState=END;
            foodPyramid.visible=false;
            infoBack.visible=false;
            ground.visible=true;
            restart.visible=true;
        }else if(mousePressedOver(infoBack)&&whereBack===2){
            win=1;
            gameState=END;
            foodPyramid.visible=false;
            infoBack.visible=false;
